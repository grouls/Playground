...
export const TaskConfig = [
    ...
    },
    {
      ...
      hint: "Consider using deep freeze in your tests to ensure data is not mutated, remember reducers are pure components and must adhere to functional programming practices. Check out the example below:",
      code: `
